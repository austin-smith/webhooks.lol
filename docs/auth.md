...
Auth is for admin capability, not for ordinary webhook inbox use.

The public app remains disposable and anonymous. Anyone can create an inbox,
send webhook traffic to it, and inspect inboxes remembered by their own browser
...
- Auth gates `/admin`, not webhook inbox creation or inspection.
...
Admin means app-wide visibility and control. It is separate from inbox access.
