...
import type { ResolvedEndpointForwardAddress } from "@webhooks-lol/webhooks-server/endpoint-forwarding/policy"
...
function normalizeLookupFamily(family: string | number | undefined): 0 | 4 | 6 {
